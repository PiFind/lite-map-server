package io.pifind.mapserver.middleware.rocketmq;
...
public class MQProducerService {
     ...
     */
    public SendResult sendMessage(String topic,Object msgBody) {
     ...
     * （适合对响应时间敏感的业务场景）
     */
    public void sendAsyncMessage(String topic,Object msgBody, SendCallback callback) {
     ...
     */
    public void sendDelayMessage(String topic,Object msgBody, int delayLevel) {
     ...
     */
    public void sendOneWayMessage(String topic,Object msgBody) {
     ...
     */
    public SendResult sendTagMessage(String topic, String tag, Object msgBody) {
