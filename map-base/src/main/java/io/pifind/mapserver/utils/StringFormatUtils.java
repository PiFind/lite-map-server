package io.pifind.mapserver.utils;

import io.pifind.mapserver.error.StringFormatSignException;
...
public class StringFormatUtils {
    ...
    private static String buildIntegerExpression(int flags, int number, int decimal, boolean upper) {
        ...
        if ((flags & COMMA_BIT) != 0) {
            nonzeroNumberExp = "[1-9]{1}[0-9]{0,2}(,[0-9]{3})*";
        } else {
            nonzeroNumberExp = "[1-9]{1}[0-9]*";
        }
...
//        System.out.printf("测试%7.6S字符串","ab+AD-12号");
//        System.out.println();
//        System.out.println(createRegularExpressionByFormatString("测试%7.6S字符串"));

//        System.out.printf("测试%5.6b布尔",true);
//        System.out.println();
//        System.out.println(createRegularExpressionByFormatString("测试%5.6b布尔"));

//        System.out.printf("测试%(, 35d整数",-1225564983);
//        System.out.println();
//        System.out.println(createRegularExpressionByFormatString("测试%(, 35d整数"));

        String hexFs = "测试%12x十六进制整数";
        System.out.printf(hexFs,-1250);
        System.out.println();
        System.out.println(createRegularExpressionByFormatString(hexFs));

//        String octFs = "测试%#12o八进制整数";
//        System.out.printf(octFs,0123451234);
//        System.out.println();
//        System.out.println(createRegularExpressionByFormatString(octFs));

//        System.out.printf("测试%8.10f浮点数",-2023.1415926);
//        System.out.println();
//        System.out.println(createRegularExpressionByFormatString("测试%f浮点数"));
